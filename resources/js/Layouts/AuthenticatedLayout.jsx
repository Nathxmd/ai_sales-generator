                        ...
                        <div className="flex items-center gap-3">
                            <div className="relative">
                                ...
                                >
                                    ...
                                    <svg
                                        className={`w-3.5 h-3.5 text-gray-400 hidden md:block transition ${userOpen ? "rotate-180" : ""}`}
                                        fill="none"
                                        viewBox="0 0 24 24"
                                        stroke="currentColor"
                                        strokeWidth={2}
                    ...
                    <div className="md:hidden border-t border-gray-100">
                        <div className="px-4 py-3 space-y-1">
                            ...
                            <div className="border-t border-gray-100 pt-2 mt-2">
                                <Link
                                    href={route("profile.edit")}
                                    className="block px-3 py-2 rounded-md text-sm text-gray-500 hover:text-gray-900 hover:bg-gray-50 transition"
                                >
                                    Profile
                                </Link>
